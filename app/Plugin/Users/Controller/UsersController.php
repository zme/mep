 ...
 */
	protected function _setupAuth() {
		...
		$this->Auth->loginRedirect = array('plugin' => false, 'admin' => false, 'controller' => 'tests', 'action' => 'dashboard');
...
/**
 * The homepage of a admin giving him an overview about everything
 *
 * @return void
 */
	...
	public function login() {
		if ($this->request->is('post')) {
			if ($this->Auth->login()) {
				...
				} else if ('admin' == $this->Auth->user('role')) {
					$this->Auth->loginRedirect = array('plugin' => false, 'admin' => true, 'controller' => 'tests', 'action' => 'dashboard');
				}
